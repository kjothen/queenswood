(ns com.repldriven.mono.bank-scheduler-processor.main
  (:require
    com.repldriven.mono.bank-scheduler-processor.system
...
(defn -main
  ...
  (let [{:keys [options exit-message ok?]}
        (cli/validate-args "bank-scheduler-processor-service" args)]
    (if exit-message

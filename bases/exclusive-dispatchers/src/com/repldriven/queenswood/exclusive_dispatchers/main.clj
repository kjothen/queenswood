(ns com.repldriven.queenswood.exclusive-dispatchers.main
  (:require
    [com.repldriven.queenswood.exclusive-dispatchers.system]
...
(defn -main
  ...
  (let [{:keys [options exit-message ok?]}
        (cli/validate-args "bank-exclusive-dispatchers" args)]
    (if exit-message

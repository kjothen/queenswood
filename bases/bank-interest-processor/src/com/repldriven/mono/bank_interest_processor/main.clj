(ns com.repldriven.mono.bank-interest-processor.main
  (:require
    com.repldriven.mono.bank-interest-processor.system
...
(defn -main
  ...
  (let [{:keys [options exit-message ok?]}
        (cli/validate-args "bank-interest-processor-service" args)]
    (if exit-message

(ns com.repldriven.mono.bank-transaction-processor.main
  (:require
    com.repldriven.mono.bank-transaction-processor.system
...
(defn -main
  ...
  (let [{:keys [options exit-message ok?]}
        (cli/validate-args "bank-transaction-processor-service" args)]
    (if exit-message

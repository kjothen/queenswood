(ns com.repldriven.mono.bank-cash-account-processor.main
  (:require
    com.repldriven.mono.bank-cash-account-processor.system
...
(defn -main
  ...
  (let [{:keys [options exit-message ok?]}
        (cli/validate-args "bank-cash-account-processor-service" args)]
    (if exit-message

(ns com.repldriven.mono.bank-cash-account-product-processor.main
  (:require
    com.repldriven.mono.bank-cash-account-product-processor.system
...
(defn -main
  ...
  (let [{:keys [options exit-message ok?]}
        (cli/validate-args "bank-cash-account-product-processor-service" args)]
    (if exit-message

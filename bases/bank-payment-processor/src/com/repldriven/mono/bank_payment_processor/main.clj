(ns com.repldriven.mono.bank-payment-processor.main
  (:require
    com.repldriven.mono.bank-payment-processor.system
...
(defn -main
  ...
  (let [{:keys [options exit-message ok?]}
        (cli/validate-args "bank-payment-processor-service" args)]
    (if exit-message

(ns com.repldriven.mono.bank-payee-check-processor.main
  (:require
    com.repldriven.mono.bank-payee-check-processor.system
...
(defn -main
  ...
  (let [{:keys [options exit-message ok?]}
        (cli/validate-args "bank-payee-check-processor-service" args)]
    (if exit-message

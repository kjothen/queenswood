(ns com.repldriven.queenswood.operational-processors.main
  (:require
    [com.repldriven.queenswood.operational-processors.system]
...
(defn -main
  ...
  (let [{:keys [options exit-message ok?]}
        (cli/validate-args "bank-operational-processors" args)]
    (if exit-message

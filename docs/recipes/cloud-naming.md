...
- seed project — `prj-b-seed-0x0x0x`
- boot identity — `sa-qw01-boot@prj-b-seed-0x0x0x.iam.gserviceaccount.com`
...
- node pool — `np-qw01-c-mgmt`
- platform identity —
  `sa-qw01-platform@prj-qw01-c-mgmt-0x0x0x.iam.gserviceaccount.com`

(ns com.repldriven.mono.pulsar.system.core
  (:require [com.repldriven.mono.pulsar.system.components :as components]
            [com.repldriven.mono.pulsar.system.testcontainers-components :as testcontainers-components]
            [com.repldriven.mono.system.interface :as system]
            [com.repldriven.mono.testcontainers-system.interface :as testcontainers-system]))
...
(defmethod component :container-service-http-url [_ v] (system/merge-component-config testcontainers-components/container-service-http-url v))
(defmethod component :container-service-url [_ v] (system/merge-component-config testcontainers-components/container-service-url v))

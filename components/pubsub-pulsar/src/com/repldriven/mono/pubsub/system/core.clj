(ns com.repldriven.mono.pubsub.system.core
  (:require [com.repldriven.mono.pubsub.system.components :as components]
            [com.repldriven.mono.pubsub.system.testcontainers-components
...
(defmethod component :consumers [_ v]
...
(defmethod component :crypto-key-pair-file-readers [_ v]
...
(defmethod component :crypto-key-readers [_ v]

(ns ^:eftest/synchronized com.repldriven.mono.cash-account-products.interface-test
  (:require
    com.repldriven.mono.testcontainers.interface
    com.repldriven.mono.fdb.interface

    [com.repldriven.mono.cash-account-products.interface :as SUT]
...
(deftest create-product-test
  (with-test-system
   [sys "classpath:cash-account-products/application-test.yml"]
     ...
     (testing "reject new version when latest is draft"
       (nom-test> [result (SUT/new-product config
                   ...
                   _ (let [rejected (SUT/new-version config
                       ...
                       (is (= :cash-account-products/draft-exists
                              (error/kind rejected))))]))

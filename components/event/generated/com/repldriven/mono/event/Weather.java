 ...
 */
package com.repldriven.mono.event;
...
public class Weather extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3780131447866438432L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Weather\",\"namespace\":\"com.repldriven.mono.event\",\"doc\":\"A weather reading.\",\"fields\":[{\"name\":\"station\",\"type\":\"string\",\"order\":\"ignore\"},{\"name\":\"time\",\"type\":\"long\"},{\"name\":\"temp\",\"type\":\"int\"}]}");
   ...
   */
  public static com.repldriven.mono.event.Weather.Builder newBuilder() {
    return new com.repldriven.mono.event.Weather.Builder();
  }
   ...
   * @return A new Weather RecordBuilder
   */
  public static com.repldriven.mono.event.Weather.Builder newBuilder(com.repldriven.mono.event.Weather.Builder other) {
    if (other == null) {
      return new com.repldriven.mono.event.Weather.Builder();
    } else {
      return new com.repldriven.mono.event.Weather.Builder(other);
    }
  }
   ...
   * @return A new Weather RecordBuilder
   */
  public static com.repldriven.mono.event.Weather.Builder newBuilder(com.repldriven.mono.event.Weather other) {
    if (other == null) {
      return new com.repldriven.mono.event.Weather.Builder();
    } else {
      return new com.repldriven.mono.event.Weather.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Weather>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.repldriven.mono.event.Weather.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.repldriven.mono.event.Weather other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.station)) {
        this.station = data().deepCopy(fields()[0].schema(), other.station);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.repldriven.mono.event.Weather.Builder setStation(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.repldriven.mono.event.Weather.Builder clearStation() {
      station = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.repldriven.mono.event.Weather.Builder setTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.repldriven.mono.event.Weather.Builder clearTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.repldriven.mono.event.Weather.Builder setTemp(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.repldriven.mono.event.Weather.Builder clearTemp() {

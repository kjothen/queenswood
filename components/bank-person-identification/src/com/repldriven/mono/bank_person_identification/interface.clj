(ns com.repldriven.mono.bank-person-identification.interface
  ...
  (:require
    [com.repldriven.mono.bank-person-identification.domain :as domain]
    [com.repldriven.mono.bank-person-identification.store :as store]))

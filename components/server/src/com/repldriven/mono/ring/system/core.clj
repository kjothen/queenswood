(ns com.repldriven.mono.ring.system.core
  (:require [com.repldriven.mono.ring.system.embedded-components :as
             embedded-components]
...
(defmethod component :interceptors
  [_ v]
  (system/merge-component-config embedded-components/interceptors v))

(defmethod component :jetty-adapter
  [_ v]
  (system/merge-component-config embedded-components/jetty-adapter v))
